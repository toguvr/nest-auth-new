...
import { IUserRepository } from 'src/users/repositories/interface/IUserRepository';
...
import PrismaUserRepository from 'src/users/repositories/implementations/prisma-user.repository';
